...
//     const distanciaSelecionadaEmKm =
//       distancia.kilometers + distancia.meters / 1000;

//     const response = await fetch(
//       "http://10.0.2.2:3000/desafio/check-completion",
//       {
//         method: "POST",
//         headers: {
...
//           distance: distanciaSelecionadaEmKm,
//         }),
//       }
//     );
...
//     return result.willCompleteChallenge;
//   };
...
//         +`${distancia.kilometers}.${distancia.meters}`;
...
//             intent:
//               !formularioValido || criarTarefaMutation.isPending
//                 ? "disabled"
//                 : null,
//           })}
